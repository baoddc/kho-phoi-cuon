...
function renderTableData(data) {
  ...
  for (let i = 1; i < data.length; i++) {
    ...
    for (let j = 0; j < headerRow.length; j++) {
      ...
      } else if (headerLower.includes('trọng lượng') || headerLower.includes('khối lượng') || headerLower.includes('số lượng') || headerLower.includes('kg') || headerLower.includes('tấn') || headerLower.includes('nhận')) {
